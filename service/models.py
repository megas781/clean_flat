...
class Service(models.Model):
    ...
    initial_price = models.IntegerField('Начальная цена')
    ...
    date_created = models.DateField('Дата создания', auto_created=True)
...
class Order(models.Model):
    ...
    order_date = models.DateField(verbose_name='Дата уборки')
...
class Review(models.Model):
    ...
    order = models.ForeignKey(Order, verbose_name='Заказ, на который оставлают отзыв', null=False,
                              on_delete=models.CASCADE, related_name='reviews_orders')
...
class Discount(models.Model):
    ...
    date_end = models.DateField('Дата окончания скидки')
